...
//
// WHAT THIS IS AND IS NOT, measured rather than assumed. Of the suite's 325 tests, essentially all
// compile through `@asmlift/toolchains` (`scoreC`, `compileTargetAsm`, `compileMipsTarget`), which
