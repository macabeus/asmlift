 ...
 * the `switch` puts every test ahead of every arm body, the ladder puts an arm's body above the
 * second test. The arms store through a pointer so each body is a `sw` the test can find.
 *
