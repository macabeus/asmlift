...
| `rank.ts`                                 | Pure candidate enumeration + `rankBy` (an injected score function ranks). Every driver ranks through `rankBy`: @asmlift/cli's sync differ scores inside it, and the three async drivers (the CLI's pooled ranker, the playground's wasm scorer, the benchmark's fan runner) compile on their own schedule, memoize the outcomes and hand `rankBy` the memo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
