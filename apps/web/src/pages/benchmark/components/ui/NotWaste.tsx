...
export function NotWaste() {
  return (
    <p className="rounded-lg border border-amber-500/25 bg-amber-500/5 px-3 py-2 text-xs leading-relaxed text-amber-200/80">
      ...
      was scored against: without the <span className="whitespace-nowrap font-mono">raw-globals</span> candidates,
      nothing shows that the named-globals spelling was better. A high price per win says where to look, never what to
      delete.
    </p>
  );
}
