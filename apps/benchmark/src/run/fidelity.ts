...
function runScript(script: string): Promise<{ code: number; stdout: string; stderr: string }> {
  ...
  return new Promise((res) => {
    ...
    // re-executions SERVED off the publishing machine's warm store: the base-vs-head asymmetry
    // this whole branch exists to bound, in the one gate whose job is to be the reader. (It also
