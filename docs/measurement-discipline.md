...
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **NO REACH** — 0 candidates enumerated                                 | no candidate `pnpm bench fan <row> --enumerate` lists carries the variation                                                            | the variation never produced a candidate; a variation that THREW prints `[threw] … threw (no candidate from it)`, which `bench run` prints nowhere |
...
| **DOES NOT COMPOSE** — it fires alone and not beside another variation | a candidate applying it without the other variation is in the fan; the candidate applying both is missing from the fan or scores worse | an interaction, not a missing capability                                                                                                           |
