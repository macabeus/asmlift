...
| **DOES NOT COMPOSE** — it fires alone and not beside another variation | present on a candidate that applies it without the other variation, absent or worse on the candidate that applies both | an interaction, not a missing capability                                                                                                           |
