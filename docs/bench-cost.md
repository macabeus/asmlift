...
| `pnpm bench fan <row> --enumerate`       | **~115 candidates/s**                                                                                                | 9,192 candidates in 80.2 s on `kleod:WorldMapScreenCheckNewWorldUnlocked:agbcc`, 2026-09-12                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- **`pnpm bench baseline <sym>`** prints the row as published _plus its price_:
  ...
  ```
  kleod:WorldMapScreenCheckNewWorldUnlocked:agbcc  asmlift=match 0/344  m2c=noncompile -/-  fan=9192 rank=146.4s
  ```
...
parallel. The single row `kleod:PauseMenuScreenHandler:agbcc` is 1,916 s of that real
...
**A log that stopped growing is almost certainly `kleod:PauseMenuScreenHandler:agbcc`** —
