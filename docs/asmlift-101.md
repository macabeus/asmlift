...
| **Target**                | asmlift's ID for one ISA+toolchain pair (`agbcc`, `ido7.1`, `gcc2.7.2kmc`, `mwcc_242_81`, `mwcc_233_163n`, `mwcc_247_107`); "target object" = the original object a candidate is byte-compared against                                                                                                                          |
